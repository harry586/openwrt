...
main() {
    case $1 in
        ...
        *)
            log "❌ 未知命令: $1"
            echo "可用命令:"
            echo "  debug_dirs - 调试目录结构"
            echo "  debug_load_device - 调试设备支持加载"

/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/tmp/compiler-build-arm_cortex-a7_musl_gcc-12.3.0_20251217_102753/build_dir/toolchain-mips_24kc_gcc-12.3.0_musl/gcc-12.3.0/gcc/config/mips/mips.md'.  */

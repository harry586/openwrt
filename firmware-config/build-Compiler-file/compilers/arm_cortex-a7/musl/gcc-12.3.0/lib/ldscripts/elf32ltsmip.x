...
OUTPUT_ARCH(mips)
ENTRY(__start)
SEARCH_DIR("=/tmp/compiler-build-arm_cortex-a7_musl_gcc-12.3.0_20251217_102753/staging_dir/toolchain-mips_24kc_gcc-12.3.0_musl/mips-openwrt-linux-musl/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{

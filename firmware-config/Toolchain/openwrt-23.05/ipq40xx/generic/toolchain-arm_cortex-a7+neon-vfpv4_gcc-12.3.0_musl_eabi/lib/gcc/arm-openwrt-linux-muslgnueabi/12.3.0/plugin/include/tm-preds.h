/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/mnt/openwrt-build/build_dir/toolchain-arm_cortex-a7+neon-vfpv4_gcc-12.3.0_musl_eabi/gcc-12.3.0/gcc/config/arm/arm.md'.  */
